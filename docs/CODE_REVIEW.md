...
| 8b | Future: extract the remaining UI surface (Interface Options panels, list-row factories, minimap, LDB, tooltip annotation). Pacing TBD - this is the densest cross-file dependency cluster in the addon, deserves careful subdivision | pending |
